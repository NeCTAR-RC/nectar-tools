...
class FreshDeskNotifierTests(test.TestCase):
    ...
    def test_send_message_extra(self, mock_api):
        ...
        with test.nested(
            ...
            mock_update.assert_called_with(
                47, n.render_template('allocations/first-warning.tmpl'))
    ...
    def test_create_ticket(self, mock_api):
        ...
        with test.nested(
            ...
            mock_render.assert_called_with(
                'allocations/ticket-description.tmpl', extra_context=extra)
            mock_api.return_value.tickets.create_ticket.assert_called_with(
                ...
                subject='Project Expiry: Project %s' % PROJECT.name,
                tags=['expiry']
            )
        ...
        with test.nested(
            ...
            mock_api.return_value.tickets.create_ticket.assert_called_with(
                description=n.render_template(
                    'allocations/ticket-description.tmpl'),
                email=CONF.freshdesk.agent_email,
                subject='Project Expiry: Project %s' % PROJECT.name,
                tags=['expiry']
            )
