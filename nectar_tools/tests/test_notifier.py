...
class NotifierTests(test.TestCase):
    ...
    def test_get_project_managers(self):
        ...
        with mock.patch.object(n, '_get_users_by_role',
                          return_value=self.managers) as mock_get_users:
    ...
    def test_get_project_members(self):
        ...
        with mock.patch.object(n, '_get_users_by_role',
                          return_value=self.members) as mock_get_users:
    ...
    def test_send_email_users(self, mock_smtp, mock_mime):
        ...
        user1 = mock.Mock()
        user1.enabled = True
        user1.email = 'user1@foo.com'
        user2 = mock.Mock()
        user2.enabled = False
        user2.email = 'user2@foo.com'
        users = [user1, user2]
...
@mock.patch('nectar_tools.auth.get_session', new=mock.Mock())
class FreshDeskNotifierTests(testtools.TestCase):
