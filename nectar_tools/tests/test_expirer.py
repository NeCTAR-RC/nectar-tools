...
class ExpiryTests(test.TestCase):
    ...
    def test_is_too_old(self):
        ...
        days = 30
        self.assertTrue(expirer.Expirer.is_too_old(start_date, days))
        days = 32
        self.assertFalse(expirer.Expirer.is_too_old(start_date, days))
...
class AllocationInstanceExpiryTests(AllocationExpiryTests):
    ...
    def test_get_notification_context_active(self):
    ...
    @freeze_time('2017-03-01')
    def test_get_notification_context_stopped(self):
        inst1 = fakes.FakeInstance(id='fake1')
        inst2 = fakes.FakeInstance(id='fake2')
        project = fakes.FakeProject('dummy', allocation_id=1,
                                    compute_zones='fake',
    ...
    @freeze_time('2017-03-01')
    def test_get_notification_context_archived(self):
        inst1 = fakes.FakeInstance(id='fake1')
        inst2 = fakes.FakeInstance(id='fake2')
        project = fakes.FakeProject('dummy', allocation_id=1,
                                    compute_zones='fake',
                                    zone_expiry_status='archived',
                                    zone_expiry_next_step='2017-03-02')
        ex = expirer.AllocationInstanceExpirer(project)
