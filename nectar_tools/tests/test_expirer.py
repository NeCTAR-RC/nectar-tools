...
class ExpiryTests(test.TestCase):
    ...
    def test_delete_project(self):
        ...
        ) as (mock_update_project, mock_archiver, mock_notifier):
...
class AllocationExpiryTests(test.TestCase):
    ...
    def test_allocation_renewed(self, mock_allocations):
        project = fakes.FakeProject()
        ex = expirer.AllocationExpirer(project)
        ex.allocation = fakes.ALLOCATIONS['active']
    ...
    def test_allocation_renewed_negative(self, mock_allocations):
        project = fakes.FakeProject()
        ex = expirer.AllocationExpirer(project)
        ex.allocation = fakes.ALLOCATIONS['active']
