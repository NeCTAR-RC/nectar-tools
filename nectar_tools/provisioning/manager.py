...
class ProvisioningManager:
    ...
    def quota_report(self, allocation, show_current=True, html=False):
        ...
        resource_map = {
            ...
            'cinder.gigabytes_adelaide': "Volume storage Adelaide (GB)",
            'cinder.gigabytes_ardc': "Volume storage ARDC (GB)",
            ...
            'cinder.gigabytes_encrypted-adelaide': "Encrypted volume storage Adelaide (GB)",
            'cinder.gigabytes_encrypted-ardc': "Encrypted volume storage ARDC (GB)",
