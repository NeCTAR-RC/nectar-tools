...
class Quota(object):
    ...
    def __repr__(self):
        return "<%s %s %s>" % (self.zone, self.resource, self.quota)
...
class Allocation(object):
    ...
    def convert_trial(self):
        ...
        #try:
        #    project = self.k_client.projects.find(name=self.tenant_name)
        #    raise
        #except keystone_exc.NotFound:
        #    pass#
