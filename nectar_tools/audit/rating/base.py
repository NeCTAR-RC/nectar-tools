...
class RatingAuditor(base.Auditor):
    ...
    def _get_group_id(self):
        ...
        return self._find_item(groups, 'instance_uptime_flavor_id', 'group_id')

    def _get_service_id(self):
        services = self.c_client.rating.hashmap.get_service()['services']
        return self._find_item(services, 'instance', 'service_id')
    ...
    def _get_field_id(self):
        ...
        return self._find_item(fields, 'flavor_id', 'field_id')
