        ...
        for a in allocations:
            ...
            if a.project_id:
                try:
                    ...
                    LOG.warning("Allocation %s: allocation's project (%s) "
                                "is missing",
                                a.id, a.project_id)
            ...
            for site in approver_info['concerned_sites']:
                if (approver_info['expiry_state'] in (
                        "Danger", "Archived", "Stopped", "Expired")
                    or approver_info["approval_urgency"] in (
                        "Warning", "Overdue")
                    or expiry_status in (expiry_states.STOPPED,
                ...
                LOG.log(level,
                        ...
                        a.id, a.status, approver_info['approval_urgency'],
                        a.modified_time, expiry_status,
