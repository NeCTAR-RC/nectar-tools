...
class AllocationAuditorBase(base.Auditor):
    ...
    def _get_allocations(
        self, allocation_id=None, current=False, pending=False
    ):
        if allocation_id:
            try:
